 ...
 * @author gamars
 */
public abstract class EmptySolrTestCase {

    protected static final Logger LOGGER = LoggerFactory.getLogger(EmptySolrTestCase.class);
    ...
    @Before
    public void clearData() throws SolrServerException, IOException{
        solrServer.deleteByQuery("*:*");
        solrServer.commit();
    }
